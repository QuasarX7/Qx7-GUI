 ...
 * @version 1.0.0, 
 * 
 * @brief File contenente l'intestazione e l'implementazione della classe Cubo.
 * 
 * @namespace Grafica
 * @class Cubo
 */
...
namespace Grafica {
    ...
    public:
        Cubo(const Colore& sfondo, const Colore& bordo, const Punto& baricentro, double lunghezza);
        virtual ~Cubo(){}
        /**
